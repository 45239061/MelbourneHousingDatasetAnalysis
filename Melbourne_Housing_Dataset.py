# -*- coding: utf-8 -*-
"""
Created on Thu Apr  5 23:29:55 2018
...
train_set = pd.read_csv("Melbourne_Housing_train.csv")
test = pd.read_csv("Melbourne_Housing_Test.csv")
ntrain = train_set.shape[0]
ntest = test.shape[0]
Y_train = train_set.Price.values
train = pd.concat((train_set, test)).reset_index(drop=True)
...
Y_pred_final = Y_pred1*0.5 + (Y_pred2 + Y_pred3)*0.25
